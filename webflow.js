 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    (r.env.safari = /safari/.test(g) && !y && !T),
      I &&
    ...
    function b() {
      m && (m.reject(), c.off("load", m.resolve)),
        (m = new u.Deferred()),
        c.on("load", m.resolve);
    }
    (r.resize = S(c, O)),
  ...
  function (t, e, n) {
    ...
    e.rawDataImported = function (t) {
      return { type: u, payload: (0, i.default)({}, w(t)) };
    };
    ...
    e.instanceRemoved = function (t) {
      return { type: m, payload: { instanceId: t } };
    };
    ...
    e.actionListPlaybackChanged = function (t) {
      var e = t.actionListId,
        n = t.isPlaying;
      return { type: S, payload: { actionListId: e, isPlaying: n } };
    };
      ...
      var f = (function (t, e, n) {
        ...
        N = function (t) {
          ...
          for (e = 0; e < w.length; e++)
            if ((n = w[e] + r) in R.style) return { dom: n, css: L[e] + t };
        },
        C = (e.support = {
      ...
      var P = (e.frame = (function () {
        ...
        F = f(function (e) {
          ...
          (e.init = function (e) {
            ...
            C.backface &&
              W.hideBackface &&
              Y(this.el, C.backface.css, "hidden");
          }),
            I("add", i),
            I("start", o),
            I("wait", function (t) {
              ...
              W.fallback || r.fallback
                ...
                : ((this.animate = this.transition),
                  (this.string =
                    ...
                    this.duration +
                    "ms" +
                    ("ease" != this.ease ? b + l[this.ease][0] : "") +
  ...
  function (t, e, n) {
    ...
    function ct(t, e) {
      ...
      if (
        (r &&
          ...
          l &&
          u &&
          (l = W({ actionListId: r, actionItemId: i, rawData: l })),
        lt({ store: e, rawData: l, allowEvents: a, testManual: c }),
        (r && n === x) || ut(n))
      ) {
        Tt({ store: e, actionListId: r }),
    ...
    function st(t, e) {
      ...
      n ? Tt({ store: e, actionListId: n }) : yt({ store: e }), dt(e);
    }
    function ft(t, e) {
                        ...
                        if ((0, f.default)(d)) {
                          (0, v.default)(d, function (t, e) {
                            ...
                            (a.actionTypeId === x || ut(a.actionTypeId)) &&
                              It({ store: n, actionListId: v, eventId: f });
                          });
                          var p = function (t) {
                              var e = n.getState(),
                                r = e.ixSession;
    ...
    function Tt(t) {
      var e = t.store,
        ...
        u = a.ixInstances,
        c =
          a.ixSession.hasBoundaryNodes && r ? y.getClosestElement(r, R) : null;
    ...
    function mt(t) {
      ...
      u >= g.length && (0, s.default)(v, "config.loop") && (u = 0),
        0 === u && I && u++;
      var T =
          (0 === u || (1 === u && I)) && ut(v.action && v.action.actionTypeId)
            ? v.config.delay
            : void 0,
          ...
          if (p) {
            ...
            M({
              ...
              var h = S === a && 0 === p,
                ...
                g = j({ element: s, actionItem: t, elementApi: y }, v);
              Ot({
                store: e,
                element: s,
                actionItem: t,
    ...
    function Ot(t) {
      ...
      e.dispatch(
        (0, I.instanceAdded)(
          (0, a.default)(
            { instanceId: l, elementId: E, origin: g, refType: _ },
            r
          )
        )
      ),
        At(document.body, "ix2-animation-started", l),
        s
          ? (function (t, e) {
            ...
            /\.webflow\.io$/i.test(p) && c.hostname !== p && (u = !0),
              u &&
                ...
                ((e =
                  e ||
                  ((n = t('<a class="n"></a>')),
                  (r = t("<img>").css({ marginRight: "8px", width: "16px" })),
                  (a = t("<img>")),
                  n.append(r, a),
                  n[0])),
                d(),
  ...
  function (t, e, n) {
    ...
    t.exports = function (t, e, n, h, _, g) {
      ...
      if (A && !O)
        return (
          g || (g = new r()),
          I || f(t) ? i(t, e, n, h, _, g) : o(t, e, T, n, h, _, g)
        );
      if (!(n & l)) {
      ...
      switch (e.type) {
        ...
        case o.IX2_INSTANCE_ADDED:
          var n = e.payload,
            ...
            v = t;
          return (
            (0, r.getIn)(v, [i, u]) !== u && (v = c(v, u, d, i, l)),
            s(v, i, p, f, l)
          );
  ...
  function (t, e, n) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
        ...
        switch (i) {
          ...
          case y.STYLE_TEXT_COLOR:
            var S = n.config,
              ...
              R = S.bValue,
              w = S.aValue;
            return { rValue: A, gValue: b, bValue: R, aValue: w };
          case y.STYLE_FILTER:
              ...
              U(t, T.TRANSFORM_PREFIXED, i),
                ...
                ((s === y.TRANSFORM_MOVE && void 0 !== d) ||
                  ...
                  (s === y.TRANSFORM_ROTATE &&
                    (void 0 !== f || void 0 !== l))) &&
                  a(t, T.TRANSFORM_STYLE_PREFIXED, g.PRESERVE_3D);
              var u, c, s, f, l, d;
            })(t, e, n, i, a);
          case g.RENDER_STYLE:
            ...
            return (function (t, e, n) {
              ...
              switch (e.actionTypeId) {
                case y.GENERAL_DISPLAY:
                  ...
                  return void (i === g.FLEX && T.IS_BROWSER_ENV
                    ? r(t, g.DISPLAY, T.FLEX_PREFIXED)
                    : r(t, g.DISPLAY, i));
              }
            })(t, i, a);
      ...
      (e.cleanupHTMLElement = function (t, e, n) {
        ...
        i(t, g.WILL_CHANGE) &&
          W({ effect: k, actionTypeId: o, elementApi: n })(t);
      }),
    ...
    var f = s(n(188)),
      ...
      O = Object.freeze(
        ((r = {}),
        (0, c.default)(r, y.STYLE_BACKGROUND_COLOR, g.BACKGROUND_COLOR),
        (0, c.default)(r, y.STYLE_BORDER, g.BORDER_COLOR),
        (0, c.default)(r, y.STYLE_TEXT_COLOR, g.COLOR),
        r)
      ),
      S = Object.freeze(
        ((i = {}),
    ...
    function N(t) {
      ...
      var w,
        ...
        C,
        x =
          (0, p.default)(n, "action.config.affectedElements", {})[_ || m] || {},
        D = Boolean(x.id || x.selector),
        P = n && u(L(n.target));
      if (
        (D
          ? ((w = x.limitAffectedElements), (N = P), (C = u(x)))
          : (N = C = u({ id: _, selector: m, selectorGuids: O })),
        n && b)
      ) {
        var M = r && (C || !0 === b) ? [r] : c(P);
        if (C) {
    ...
    function H(t) {
      ...
      e.actionItems.forEach(function (t) {
        ...
        (e = (0, _.isPluginType)(i)
          ? (0, _.clearPlugin)(i)
          : W({ effect: Y, actionTypeId: i, elementApi: r })),
          N({ config: o, event: n, elementApi: r }).forEach(e);
      });
    }
    var W = function (t) {
      var e = t.effect,
    ...
    function Y(t, e, n) {
      ...
      k(t, e, n),
        r(t, e, ""),
        e === T.TRANSFORM_PREFIXED && r(t, T.TRANSFORM_STYLE_PREFIXED, "");
    }
    function z(t) {
      var e = 0,
        n = 0;
    ...
    e.ixSession = function () {
      ...
      switch (e.type) {
        ...
        case v:
          ...
          return (0, i.merge)(t, { viewportWidth: b, mediaQueryKey: L });
        case E:
      ...
      y = function (t, e) {
        ...
        for (var S = 0, A = o.length; S < A; S++) {
          ...
          if ((0 === S && (E = w[0]), O >= R)) {
            ...
            var L = o[S + 1],
              N = L && O !== R;
            (h = N ? L.actionItems[0] : null),
              N && ((g = R / 100), (I = (L.keyframe - R) / 100));
          }
        }
        var C = {};
        if (E && !h)
      ...
      switch (e.type) {
        ...
        case s:
          var X = e.payload,
            V = X.instanceId,
            U = X.time;
          return (0, i.mergeIn)(t, [V], { active: !0, complete: !1, start: U });
        case f:
          var k = e.payload.instanceId;
          if (!t[k]) return t;
          for (
            var B = {}, H = Object.keys(t), W = H.length, Y = 0;
            Y < W;
            Y++
          ) {
            var z = H[Y];
  ...
  function (t, e, n) {
    ...
    var c,
      ...
      it = { handler: rt(tt, nt) },
      ot = (0, l.default)({}, it, { types: [F, j].join(" ") }),
      at = [
      ...
      vt = function (t) {
        return function (e) {
          ...
          n &&
            ((E = v > n.percentTop),
            (g = (h = n.scrollingDown !== E) ? v : n.anchorTop));
      ...
      It =
        ...
        (0, o.default)(r, m, (0, l.default)({}, it, { types: "mouseup" })),
        (0, o.default)(r, O, {
        ...
        (0, o.default)(r, D, {
          ...
          handler: function (t) {
            ...
            return (
              ...
              (u !== Y || b || b !== a.elementHovered) &&
                ((S = f ? 1 - S : S),
                e.dispatch((0, h.parameterChanged)(A, S))),
              { elementHovered: b, clientX: v, clientY: _, pageX: I, pageY: T }
            );
          },
        }),
        (0, o.default)(r, W, {
        ...
        (0, o.default)(r, V, {
          ...
          handler: function (t) {
            ...
            if (d === z) {
              ...
              return (
                S !== o.scrollPercent &&
                  n.dispatch((0, h.parameterChanged)(v, S)),
                { scrollPercent: S }
              );
            }
            var A = q(i, v),
            ...
            return (
              x !== o.scrollPercent &&
                n.dispatch((0, h.parameterChanged)(A, x)),
              { scrollPercent: x }
            );
          },
        }),
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "04a90f1f-1bdd-28b4-c796-d297e23b2a0e",
                    "7c70f3fe-2ef7-ba1b-0aa6-b007927c8e18",
                  ],
                },
                value: 0.3,
                unit: "",
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "47c729cd-3984-2932-2609-2060ae089aa2",
                    "7345e75f-f190-e08f-c1ff-315e52ea5795",
                  ],
                },
                yValue: 0,
                xUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "804a9fbe-4f78-1387-223d-f7359968089a",
                    "c406171d-a2e1-f98f-a93e-6b2f4848bc06",
                  ],
                },
                heightValue: 100,
                widthUnit: "PX",
            ...
            },
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: [
                    "804a9fbe-4f78-1387-223d-f7359968089a",
                    "82607b6c-0084-4a53-5433-6fdc7bec1a7e",
                  ],
                },
                heightValue: 100,
                widthUnit: "PX",
